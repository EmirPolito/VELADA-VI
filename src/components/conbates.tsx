...
const FightSection = ({ readMoreLink, fighter1, fighter2, fightNumber = 1 }: FightSectionProps) => {
  ...
  return (
    <motion.section
      ...
      className="relative flex min-h-screen w-full flex-col overflow-hidden bg-black py-32"
    >
      <div
    ...
    <FightSection
      ...
      fighter1={{
        ...
        socialLinks: [
          ...
          { icon: Twitch,    href: "https://www.twitch.tv/yosoyplex" },
      ...
      fighter2={{
        ...
        socialLinks: [
          ...
          { icon: Youtube,   href: "https://www.youtube.com/@Fernanfloo" },
        ],
        config: {
          circleSize:        "h-[380px] w-[380px]",
          imgSize:           "w-full",
